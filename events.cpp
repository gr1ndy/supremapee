...
uint8_t* dghsadfdefault(HMODULE hModule, const char* szSignature)
{
...
void events::player_death( IGameEvent* evt ) {
	...
	//{
	//	if (!ClearDeathNotices) ClearDeathNotices = (void(__thiscall*)(DWORD))dghsadfdefault(GetModuleHandleA("client.dll"), "55 8B EC 83 EC 0C 53 56 8B 71 58");
