...
{
public:
	virtual ~sagsad() = default;
	virtual void SetRefEHandle(const uint32_t& handle) = 0;
	virtual const uint32_t& GetRefEHandle() const = 0;
};
...
class IClientUnknown : public sagsad
{
public:
	virtual void* GetCollideable() = 0;
	virtual IClientNetworkable* GetClientNetworkable() = 0;
	virtual void* GetClientRenderable() = 0;
	virtual Player* GetIClientEntity() = 0;
	virtual Player* GetBaseEntity() = 0;
