...
bool Hooks::IsConnected( ) {
	...
	return g_hooks.shonax_3_fix.get_original< IsConnected_t >( IVEngineClient::ISCONNECTED )( this );
}
...
bool Hooks::IsHLTV( ) {
	...
	return g_hooks.shonax_3_fix.get_original< IsHLTV_t >(IVEngineClient::ISHLTV)(this);
}
