...
bool Hooks::TempEntities( void *msg ) {
	if( !g_cl.m_processing ) {
		return g_hooks.m_temp.GetOldMethod< TempEntities_t >( CClientState::TEMPENTITIES )( this, msg );
	}

	const bool ret = g_hooks.m_temp.GetOldMethod< TempEntities_t >( CClientState::TEMPENTITIES )( this, msg );
