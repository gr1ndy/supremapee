...
public:
	...
	{
		return util::get_method<void(__thiscall*)(void*, int)>(this, 75)(this, modelIndex);
	}
...
public:
	...
	__forceinline int &m_fFlags() {
		return get< int >(0x104);
	}

	__forceinline int &m_MoveType() {
		return get< int >(0x25C);
	}
...
public:
	...
	__forceinline int& m_BoneCacheCount() {
		return get< int >(g_entoffsets.m_BoneCache + 0xc);
	}
...
public:
	...
	__forceinline EHANDLE& m_hOwner() {
		return get< EHANDLE >(0x29CC);
	}
...
public:
	...
	__forceinline bool IsKnife() {
		return (m_iItemDefinitionIndex() == Weapons_t::KNIFE_CT || m_iItemDefinitionIndex() == Weapons_t::KNIFE_T || m_iItemDefinitionIndex() != ZEUS || m_iItemDefinitionIndex() >=500 );
	}
